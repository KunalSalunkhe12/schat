      ...
      "user_profile": {
        ...
        "properties": {
          ...
          "location": {
            "type": "object",
            "properties": {
              "their_location": {"type": "string"},
              "willingness_to_relocate": {"type": "string"}
            },
            "required": ["their_location", "willingness_to_relocate"],
            "additionalProperties": False
          },
          "spirituality": {
            "type": "object",
            "properties": {
              "their_spirituality": {"type": "string"},
              "spirituality_preferred_in_partner": {"type": "string"}
            },
            "required": ["their_spirituality", "spirituality_preferred_in_partner"],
            "additionalProperties": False
          },
          "personality_attributes": {
            "type": "object",
            "properties": {
              "their_personality_attributes": {"type": "string"},
              "personality_attributes_preferred_in_partner": {"type": "string"}
            },
            "required": ["their_personality_attributes", "personality_attributes_preferred_in_partner"],
            "additionalProperties": False
          },
          "age": {
            "type": "object",
            "properties": {
              "their_age": {"type": "integer"},
              "preferred_age_range_for_partner": {"type": "string"}
            },
            "required": ["their_age", "preferred_age_range_for_partner"],
            "additionalProperties": False
          },
          "interests": {
            "type": "object",
            "properties": {
              "their_interests": {"type": "string"},
              "preferred_interests_in_partner": {"type": "string"}
            },
            "required": ["their_interests", "preferred_interests_in_partner"],
            "additionalProperties": False
          },
          "identity_and_preference": {
            "type": "object",
            "properties": {
              "their_identity": {"type": "string"},
              "desired_identity_for_partner": {"type": "string"}
            },
            "required": ["their_identity", "desired_identity_for_partner"],
            "additionalProperties": False
          },
          "kids": {
            "type": "object",
            "properties": {
              "has_kids_or_wishes_to_have_kids": {"type": "string"},
              "preference_for_partner_having_kids": {"type": "string"}
            },
            "required": ["has_kids_or_wishes_to_have_kids", "preference_for_partner_having_kids"],
            "additionalProperties": False
          },
          "smoking": {"type": "string"},
          "pets": {"type": "string"},
          ...
          "willingness_to_travel": {"type": "string"},
...
def call_openai_assistant(all_messages):
    ...
    response = openai.ChatCompletion.create(
        model="gpt-4",  # Adjust model as per the usage.
